# -*- coding: utf-8 -*-
"""生成 WB_2026-09-11_硬件看板.html（每日智能终端硬件情报日报，单 HTML / 内联 CSS / 无 CDN）"""
...
cn = json.load(open(f"{BASE}/_agent_cn_2026-09-11.json", encoding="utf-8"))
intl = json.load(open(f"{BASE}/_agent_intl_2026-09-11.json", encoding="utf-8"))
